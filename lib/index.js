 ...
 * @returns {XLoggerType}
 */
function XLoggerTypeEnumToString(XLoggerType) {
 ...
 * @returns {XLoggerTypeEnum}
 */
function XLoggerTypeStringToEnum(XLoggerType) {
  if (typeof XLoggerType !== 'string') { throw XLoggerError.TypeError(DefaultArgumentTypeError('XLoggerType', 'string')); }
  return XLoggerTypeEnum[XLoggerType.toUpperCase()];
}
...
function XLogger(option, useStyleParser) {
  ...
  if (typeof option === 'string') {
    if (ObjectToArray(XLoggerTypeEnum, 'key', function (value) { return value.toLowerCase(); }).includes(option.toLowerCase())) { _xlogger_default_config = option; }
    ...
    _xlogger_this,
    {
      ...
      logLevel: {
        ...
        set: function logLevel(value) {
          if (typeof value === 'string' && ObjectToArray(XLoggerTypeEnum, 'key', function (value) { return value.toLowerCase(); }).includes(value.toLowerCase())) {
            _xlogger_define_options_log_level = XLoggerTypeStringToEnum(value);
          } else if (typeof value === 'number' && ObjectToArray(XLoggerTypeEnum, 'value').includes(value)) {
      ...
      Warn: { value: BuildXLoggerMethod('warn', XLoggerTypeEnum.WARNING) },
      Error: { value: BuildXLoggerMethod('error', XLoggerTypeEnum.ERROR) },
      GroupEnd: { value: BuildXLoggerMethod('groupEnd', XLoggerTypeEnum.ERROR, true) },
      TimeEnd: { value: BuildXLoggerMethod('timeEnd', XLoggerTypeEnum.ERROR, true) },
      TimeLog: { value: BuildXLoggerMethod('timeLog', XLoggerTypeEnum.ERROR, true) },
      Table: { value: BuildXLoggerMethod('table', XLoggerTypeEnum.ERROR, true) },
      Group: { value: BuildXLoggerMethod('group', XLoggerTypeEnum.ERROR, true) },
      Count: { value: BuildXLoggerMethod('count', XLoggerTypeEnum.ERROR, true) },
      Info: { value: BuildXLoggerMethod('info', XLoggerTypeEnum.INFO) },
      Time: { value: BuildXLoggerMethod('time', XLoggerTypeEnum.ERROR, true) },
      Log: { value: BuildXLoggerMethod('log', XLoggerTypeEnum.INFO) }
    }
  );

  function BuildXLoggerMethod(name, minLogLevel, isAltMethod) {
    if (typeof isAltMethod !== 'boolean') {
      isAltMethod = false;
    }

    var _xlogger_mount_logger_custom_function;
    if (typeof globalThis[Symbol.for(XLoggerMakeSymbolKey('logger.' + name))] === 'function') {
      _xlogger_mount_logger_custom_function = globalThis[Symbol.for(XLoggerMakeSymbolKey('logger.' + name))];
  ...
  var _xlogger_non_blocking_methods = Object.create(
    Object.prototype,
    {
      Warn: { value: BuildXLoggerMethod('warn', XLoggerTypeEnum.SILENT) },
      Error: { value: BuildXLoggerMethod('error', XLoggerTypeEnum.SILENT) },
      GroupEnd: { value: BuildXLoggerMethod('groupEnd', XLoggerTypeEnum.SILENT) },
      TimeEnd: { value: BuildXLoggerMethod('timeEnd', XLoggerTypeEnum.SILENT) },
      TimeLog: { value: BuildXLoggerMethod('timeLog', XLoggerTypeEnum.SILENT) },
      Table: { value: BuildXLoggerMethod('table', XLoggerTypeEnum.SILENT) },
      Group: { value: BuildXLoggerMethod('group', XLoggerTypeEnum.SILENT) },
      Count: { value: BuildXLoggerMethod('count', XLoggerTypeEnum.SILENT) },
      Info: { value: BuildXLoggerMethod('info', XLoggerTypeEnum.SILENT) },
      Time: { value: BuildXLoggerMethod('time', XLoggerTypeEnum.SILENT) },
      Log: { value: BuildXLoggerMethod('log', XLoggerTypeEnum.SILENT) }
    }
  );
...
Object.defineProperties(
  ...
  {
    BuildXLoggerMethod: {
      value: function BuildXLoggerMethod(_this, name, minLogLevel, isAltMethod) {
        if (typeof isAltMethod !== 'boolean') {
          isAltMethod = false;
        }
        ...
        var _xlogger_mount_logger_function = XLogger[Symbol.for(XLoggerMakeSymbolKey('logger.handler'))].bind(_this, _xlogger_mount_logger_custom_function, minLogLevel, isAltMethod);
