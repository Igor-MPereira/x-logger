...
function XLogger(option, useStyleParser) {
  ...
  function PrivateBuildXLoggerMethod(func, minLogLevel) {
    return function () {
      XLogger[Symbol.for(XLoggerMakeSymbolKey('logger.handler'))].call(null, Array.apply(null, arguments), minLogLevel, func, false, _xlogger_this);
    };
  }
...
Object.defineProperty(
  ...
  Symbol.for(XLoggerMakeSymbolKey('logger.handler')),
  {
    value: function (args, minLogLevel, func, isAltMethod, logger) {
      if ((logger.logLevel < minLogLevel) || (isAltMethod && !logger.useAltMethods)) { return; }
...
Object.defineProperty(
  ...
  'BuildXLoggerMethod',
  {
    value: function BuildXLoggerMethod(name, minLogLevel, func, isAltMethod, handler) {
      ...
      XLogger.prototype[name] = function () {
        var _xlogger_custom_method_args = Array.apply(null, arguments);
        _xlogger_build_logger_handler.call(null, _xlogger_custom_method_args, minLogLevel, func, isAltMethod, this);
      };
    }
  }
);
...
XLogger.BuildXLoggerMethod('GroupEnd', XLoggerLogLevelEnum.ERROR, console.groupEnd, true);
XLogger.BuildXLoggerMethod('TimeEnd', XLoggerLogLevelEnum.ERROR, console.timeEnd, true);
XLogger.BuildXLoggerMethod('TimeLog', XLoggerLogLevelEnum.ERROR, console.timeLog, true);
XLogger.BuildXLoggerMethod('Table', XLoggerLogLevelEnum.ERROR, console.table, true);
XLogger.BuildXLoggerMethod('Group', XLoggerLogLevelEnum.ERROR, console.group, true);
XLogger.BuildXLoggerMethod('Count', XLoggerLogLevelEnum.ERROR, console.count, true);
XLogger.BuildXLoggerMethod('Time', XLoggerLogLevelEnum.ERROR, console.time, true);
XLogger.BuildXLoggerMethod('Warn', XLoggerLogLevelEnum.WARNING, console.warn);
XLogger.BuildXLoggerMethod('Error', XLoggerLogLevelEnum.ERROR, console.error);
XLogger.BuildXLoggerMethod('Info', XLoggerLogLevelEnum.INFO, console.info);
XLogger.BuildXLoggerMethod('Log', XLoggerLogLevelEnum.INFO, console.log);
